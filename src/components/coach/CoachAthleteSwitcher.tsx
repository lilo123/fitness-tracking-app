      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="w-full sm:w-auto min-w-0">
          <select
            ...
            className="w-full sm:w-64 max-w-full truncate bg-zinc-900 border border-border-interactive text-white rounded-xl px-3 py-2.5 text-base sm:text-xs font-bold focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/50 outline-none cursor-pointer min-h-[44px]"
          >
