        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full sm:w-36 min-h-[44px] bg-zinc-900 border border-border-interactive text-amber-400 rounded-xl p-2.5 text-lg font-mono font-black focus:border-amber-500 outline-none text-center shadow-inner"
              required
            />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-3">
            ...
            <input
              ...
              className="w-full min-h-[44px] bg-zinc-900 border border-border-interactive text-white rounded-xl p-2.5 text-base sm:text-xs font-mono font-bold focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/50 outline-none text-center"
              required
            />
          </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-3">
            ...
            <input
              ...
              className="w-full min-h-[44px] bg-zinc-900 border border-border-interactive text-white rounded-xl p-2.5 text-base sm:text-xs font-mono font-bold focus:border-emerald-500 outline-none text-center"
              required
            />
          </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-3">
            ...
            <input
              ...
              className="w-full min-h-[44px] bg-zinc-900 border border-border-interactive text-white rounded-xl p-2.5 text-base sm:text-xs font-mono font-bold focus:border-violet-500 focus:ring-2 focus:ring-violet-500/50 outline-none text-center"
              required
            />
          </div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-3">
            ...
            <input
              ...
              className="w-full min-h-[44px] bg-zinc-900 border border-border-interactive text-white rounded-xl p-2.5 text-base sm:text-xs font-mono font-bold focus:border-teal-500 outline-none text-center"
              required
            />
          </div>
        </div>
