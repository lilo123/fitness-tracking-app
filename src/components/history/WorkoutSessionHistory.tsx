...
export const WorkoutSessionHistory: React.FC<WorkoutSessionHistoryProps> = ({
  ...
  // or when the window resizes. The workout sessions list sits below dynamic controls (time range pills,
  // athlete selector/filter badges) whose conditional rendering shifts the container's offsetTop
  // after mount. Tracking offsetTop dynamically ensures useWindowVirtualizer computes accurate
  // window scroll offsets, preventing session cards from prematurely unmounting during window scroll.
